...
generate_alacritty_config() {
  ...
  cat <<EOF
# generated by shellscripts/sync_colours_xterm_to_alacritty.sh from .Xdefaults
...
[colors.normal]
  ...
  blue =    '${colour_value[12]}' #${colour_str[12]} swap normal with bright alacritty fault??
  magenta = '${colour_value[13]}' #${colour_str[13]} swap normal with bright alacritty fault??
...
[colors.bright]
  ...
  blue =    '${colour_value[4]}' #${colour_str[4]} swap normal with bright alacritty fault??
  magenta = '${colour_value[5]}' #${colour_str[5]} swap normal with bright alacritty fault??
